...
import 'package:flatypus/features/home/presentation/widgets/show_more_space_card.dart';
...
import 'package:flatypus/features/space/presentation/pages/manage_space_screen.dart';
...
class SpaceCard extends StatelessWidget {
        ...
        : Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Flexible(flex: 2, child: _buttonsRowSection()),
            ],
          ),
        );
  }
  ...
  Widget _buttonsRowSection() {
    return Padding(
      ...
      child: Row(
        ...
        children: [_manageSpaceIconButton(), _addTaskForSpaceButton()],
      ),
    );
  }
  ...
  Widget _manageSpaceIconButton() => IconButton(
    ...
    icon: const Icon(Icons.settings, color: AppColors.white, size: 16),
