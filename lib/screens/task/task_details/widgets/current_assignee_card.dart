...
import '../../add_task/widgets/assigned_user_card.dart';
              ...
              children: [
                ...
                if (!isFutureAssignment)
                  Padding(
                    ...
                    child: InkWell(
                        onTap: () {
                          TaskAssign.updateTaskScheduleDate(
        ...
        child: Row(
          ...
          children: [
            CustomTextNIconButton(
              ...
              onTap: () => TaskAssign.markDoneButtonOnTap(
                  context: context, ref: ref, task: task, isSkipped: true),
