...
import '../../../common/widgets/custom_outline_navigation_button.dart';
import '../../../common/widgets/text_with_icon_header.dart';
import '../../../models/house_model.dart';
import '../../../theme/app_colors.dart';
import '../../house/manage_house_screen.dart';
import '../../house/widgets/house_name_text.dart';
import 'multiple_users_image_stack.dart';
...
class HouseInfoCard extends StatelessWidget {
  ...
  static Widget displayhouseKey(HouseModel house,
  ...
  static Widget userDetailsTab(BuildContext context,
      {Level level = Level.medium}) {
  ...
  static Widget houseDetailsTab(HouseModel house,
      {Level level = Level.medium}) {
          ...
          child: Column(
            ...
            children: [
              displayHouseNameText(
                  label: house.displayName, fontSize: fontSize),
